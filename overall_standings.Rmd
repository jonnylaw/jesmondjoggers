...
winter_results %>%
  ...
  select(position, total_races, first_name, second_name, points, `20181`, `20182`, `20183`) %>%
  arrange(desc(total_races), position) %>%
  select(-total_races) %>%
  knitr::kable(format = "html", booktabs = T, col.names = c("Position", "First", "Second", "Points", "Handicap 1", "Handicap 2", "Handicap 3")) %>% 
